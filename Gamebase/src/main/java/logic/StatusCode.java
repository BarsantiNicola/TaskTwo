...
public enum StatusCode
{
 ...
 ERR_GRAPH_CONN_MISSINGARGUMENTS       { @Override public String toString() { return "[GraphConnectorError]: Insufficient arguments to attempt to connecto to a Neo4j database"; } },
 ...
 //------------------User-related Errors-------------------
 ERR_GRAPH_USER_MISSINGARGUMENTS       { @Override public String toString() { return "[GraphConnectorError]: Insufficient arguments to perform the operation"; } },
 ...
 ERR_GRAPH_USER_NOTPOSITIVELIMIT       { @Override public String toString() { return "[GraphConnectorError]: The \"max\" parameter passed to the function is non-positive"; } },
 ...
 //------------------Game-Related Errors-------------------
 ERR_GRAPH_GAME_MISSINGARGUMENTS       { @Override public String toString() { return "[GraphConnectorError]: Insufficient arguments to perform the operation"; } },
